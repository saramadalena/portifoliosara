...
// Foto pessoal mais discreta para o texto de trajetória manter protagonismo.
r("<div style={{ maxWidth: '280px', position: 'relative' }}>", "<div style={{ maxWidth: isMobile ? '220px' : '210px', position: 'relative' }}>")

// Galerias com menos altura e legendas menos fragmentadas.
r("style={{ height: '300px', backgroundColor: T.white", "style={{ height: '260px', backgroundColor: T.white")
r("style={{ height: '300px', backgroundColor: T.bg", "style={{ height: '260px', backgroundColor: T.bg")
r("padding: '9px 12px 11px'", "padding: '8px 10px 9px'")
r("fontSize: '8px', fontWeight: 700, letterSpacing: '0.18em'", "fontSize: '8px', fontWeight: 600, letterSpacing: '0.12em'")
...
console.log('Balanço visual aplicado: Intermodal, capas move.e, foto pessoal, galerias e produto SPDATA.')
