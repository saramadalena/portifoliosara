...
r('Startup de Tecnologia — Gestão ASG', 'Comunicação, Branding e projetos')
r('Posicionamento · Narrativa Institucional · Comunicação para Stakeholders', 'Conteúdo · Materiais corporativos · Eventos')
r('Freelance de Marketing, Branding e Conteúdo · 2024–2025', 'move.e · 2025')
r('Posicionamento de Marca', 'Branding')
r('Arquitetura de Mensagens', 'Conteúdo')
r('Comunicação com Stakeholders', 'Comunicação institucional')
r('Consultoria', 'Projetos')
r('Cobertura e representação institucional da move.e', 'Conteúdo e cobertura digital')

fs.writeFileSync(file, s)
console.log('Ajustes de cases aplicados.')
